...
label=Label(label);
label=label(51:200);
mirdata=mpcdata(51:200,1:93);
petdata=mpcdata(51:200,94:186);
csfdata=mpcdata(51:200,187:189);
...
[predict_label1, accuracy2, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1 ');
[predict_label2, accuracy3, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1 ');
[predict_label3, accuracy4, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1 ');
[predict_label4, accuracy5, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1 ');
[predict_label5, accuracy6, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1 ');
[predict_label6, accuracy7, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1 ');
[predict_label7, accuracy8, dec_values] = svmpredict(label_test,data_test,model);
...
model = svmtrain(label_train,data_train,'-c 1 -t 2 -s 1');
[predict_label8, accuracy1, dec_values] = svmpredict(label_test,data_test,model);
